...
# NOTE: the upstream `export extern "nix registry list"` was removed here:
# general.nu intentionally shadows `nix registry list` with a custom command
# that pretty-prints the output as a table (owner, flakeref, ui).
